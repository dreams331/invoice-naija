![Docker images](https://github.com/invoicenaija/dockerfiles/workflows/Docker%20images/badge.svg)
...
# Docker for [Invoice Naija](https://www.invoicenaija.com/)
...
```bash
git clone https://github.com/invoicenaija/dockerfiles.git
cd dockerfiles
```
...
```bash
docker run --rm -it invoicenaija/invoicenaija php artisan key:generate --show
```
